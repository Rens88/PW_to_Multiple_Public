...
% % % % % % % % % % % % % % % % % subplot(2,1,1)
% % % % % % % % % % % % % % % % % hold off;
% % % % % % % % % % % % % % % % % plot(xw1,yw1,'b');hold on;
% % % % % % % % % % % % % % % % % plot(xw2,yw2,'r')
% % % % % % % % % % % % % % % % % plot(xw3,yw3,'g')
% % % % % % % % % % % % % % % % % if xw1(end) < xw1(1)
% % % % % % % % % % % % % % % % %     plot(xw1(end),yw1(end),'<b','MarkerSize',8)
% % % % % % % % % % % % % % % % % else
% % % % % % % % % % % % % % % % %     plot(xw1(end),yw1(end),'>b','MarkerSize',8)
% % % % % % % % % % % % % % % % % end
% % % % % % % % % % % % % % % % % if yw2(end) < yw2(1)
% % % % % % % % % % % % % % % % % plot(xw2(end),yw2(end),'vr','MarkerSize',8,'MarkerFaceColor',[0 0 0])
% % % % % % % % % % % % % % % % % plot(xw3(end),yw3(end),'vg','MarkerSize',8)
% % % % % % % % % % % % % % % % % else
% % % % % % % % % % % % % % % % %     plot(xw2(end),yw2(end),'^r','MarkerSize',8,'MarkerFaceColor',[0 0 0])
% % % % % % % % % % % % % % % % % plot(xw3(end),yw3(end),'^g','MarkerSize',8,'MarkerFaceColor',[0 0 0])
% % % % % % % % % % % % % % % % % end
% % % % % % % % % % % % % % % % % text(xw1(1),yw1(1)-2,'W1')
% % % % % % % % % % % % % % % % % 
% % % % % % % % % % % % % % % % % if xw2(1) > xw3(1)
% % % % % % % % % % % % % % % % % text(xw2(1)+.2,yw2(1),'W2')
% % % % % % % % % % % % % % % % % text(xw3(1)-1.2,yw3(1),'W3')
% % % % % % % % % % % % % % % % % else
% % % % % % % % % % % % % % % % % text(xw2(1)-1.2,yw2(1),'W2')
% % % % % % % % % % % % % % % % % text(xw3(1)+.2,yw3(1),'W3')
% % % % % % % % % % % % % % % % % end
% % % % % % % % % % % % % % % % % tip12_1 = [xw1(out{j,i}.timing(15)) yw1(out{j,i}.timing(15))];
% % % % % % % % % % % % % % % % % tip12_2 = [xw2(out{j,i}.timing(15)) yw2(out{j,i}.timing(15))];
% % % % % % % % % % % % % % % % % 
% % % % % % % % % % % % % % % % % tip13_1 = [xw1(out{j,i}.timing(14)) yw1(out{j,i}.timing(14))];
% % % % % % % % % % % % % % % % % tip13_3 = [xw3(out{j,i}.timing(14)) yw3(out{j,i}.timing(14))];
% % % % % % % % % % % % % % % % % plot(tip12_1(1),tip12_1(2),'*b');hold on;
% % % % % % % % % % % % % % % % % plot(tip13_1(1),tip13_1(2),'.b','MarkerSize',8);hold on;
% % % % % % % % % % % % % % % % % plot(tip12_2(1),tip12_2(2),'*r')
% % % % % % % % % % % % % % % % % plot(tip13_3(1),tip13_3(2),'.g','MarkerSize',8)
% % % % % % % % % % % % % % % % % 
% % % % % % % % % % % % % % % % % title('DG at ip')
% % % % % % % % % % % % % % % % % ylabel('y position (m)')
% % % % % % % % % % % % % % % % % xlabel('x position (m)')
...
% % % % % % % % % % % % % % % % % end
% % % % % % % % % % % % % % % % % if yw2(end) < yw2(1)
% % % % % % % % % % % % % % % % % plot(xw2(end),yw2(end),'vr','MarkerSize',8)
% % % % % % % % % % % % % % % % % plot(xw3(end),yw3(end),'vg','MarkerSize',8)
% % % % % % % % % % % % % % % % % else
% % % % % % % % % % % % % % % % %     plot(xw2(end),yw2(end),'^r','MarkerSize',8)
% % % % % % % % % % % % % % % % % plot(xw3(end),yw3(end),'^g','MarkerSize',8)
% % % % % % % % % % % % % % % % % end
% % % % % % % % % % % % % % % % % text(xw1(1),yw1(1)-2,'W1')
% % % % % % % % % % % % % % % % % 
% % % % % % % % % % % % % % % % % if xw2(1) > xw3(1)
...
% % % % % % % % % % % % % % % % % end
% % % % % % % % % % % % % % % % % 
% % % % % % % % % % % % % % % % % tip12_1 = [xw1(out{j,i}.timing(6)) yw1(out{j,i}.timing(6))];
% % % % % % % % % % % % % % % % % tip12_2 = [xw2(out{j,i}.timing(6)) yw2(out{j,i}.timing(6))];
% % % % % % % % % % % % % % % % % 
% % % % % % % % % % % % % % % % % tip13_1 = [xw1(out{j,i}.timing(1)) yw1(out{j,i}.timing(1))];
% % % % % % % % % % % % % % % % % tip13_3 = [xw3(out{j,i}.timing(1)) yw3(out{j,i}.timing(1))];
% % % % % % % % % % % % % % % % % 
% % % % % % % % % % % % % % % % % plot(tip12_1(1),tip12_1(2),'*b');hold on;
% % % % % % % % % % % % % % % % % plot(tip13_1(1),tip13_1(2),'.b','MarkerSize',8);hold on;
% % % % % % % % % % % % % % % % % plot(tip12_2(1),tip12_2(2),'*r')
...
% % % % % % % % % % % % % % % % % xlabel('x position (m)')
% % % % % % % % % % % % % % % % % 
% % % % % % % % % % % % % % % % % print( h11, '-r300' ,'-dtiff' ,[fpath 'gapexplanation.tiff']) % here you can specify filename extensions
...
% plot(xw1_1(1:tp),yw1_1(1:tp),'b');hold on;
% plot(xw2_1(1:tp),yw2_1(1:tp),'r');
% plot(xw3_1(1:tp),yw3_1(1:tp),'g');
% 
% % predicted displacement based on current velocity vector
% plot(vxw1_1,vyw1_1,'--b');
% plot(vxw2_1,vyw2_1,'--r');
% plot(vxw3_1,vyw3_1,'--g');
% 
% % position when w1 intersects respective trajectory
% plot(vxw1_1(ip12_1),vyw1_1(ip12_1),'*b');
% plot(vxw2_1(ip12_1),vyw2_1(ip12_1),'*r');
% plot(vxw1_1(ip13_1),vyw1_1(ip13_1),'ob');
% plot(vxw3_1(ip13_1),vyw3_1(ip13_1),'og');
% 
% % plot the hypothetical 'door'
% plot(vxw1_1(end),vyw1_1(end) + DG2_1,'*k')
% plot(vxw1_1(end),vyw1_1(end) + DG3_1,'ok')
% 
% if vxw1_1(end) < xw1_1(1)
%     plot(vxw1_1(end),vyw1_1(end),'<b','MarkerSize',8)
% else
%     plot(vxw1_1(end),vyw1_1(end),'>b','MarkerSize',8)
% end
% if vyw2_1(end) < yw2_1(1)
% plot(vxw2_1(end),vyw2_1(end),'vr','MarkerSize',8)
% plot(vxw3_1(end),vyw3_1(end),'vg','MarkerSize',8)
% else
%     plot(vxw2_1(end),vyw2_1(end),'^r','MarkerSize',8)
% plot(vxw3_1(end),vyw3_1(end),'^g','MarkerSize',8)
% end
% text(xw1_1(1),yw1_1(1)-1,'W1')
% 
% if xw2_1(1) > xw3_1(1)
% text(xw2_1(1)+.2,yw2_1(1),'W2')
% text(xw3_1(1)-1.2,yw3_1(1),'W3')
% else
% text(xw2_1(1)-1.2,yw2_1(1),'W2')
% text(xw3_1(1)+.2,yw3_1(1),'W3')
% end
% 
% axis([-8 8 -8 8])
...
% temp = gap_evolution_revised([vxw1; vyw1]',vtemp1,[vxw2; vyw2]',vtemp2, ...
%     [vxw3; vyw3]',vtemp3,[length(vxw1),NaN,length(vxw1),NaN]);
...
% position when w1 intersects respective trajectory
% plot(vxw1(ip12),vyw1(ip12),'*k');
plot(vxw2(ip12),vyw2(ip12),'*','Color',c2);
% plot(vxw1(ip13),vyw1(ip13),'ok');
...
% plot(vxw1(ip12),vyw1(ip12),'*k');
% plot(Bx,By,'*k'); % fake position W1

% plot([Ax Bx],[Ay By],'Color',cvirt)
% plot([Cx Dx],[Cy Dy],'Color',cvirt)
% plot([Cx Bx],[Cy By],'Color',cvirt)
...
% 
% plot(vxw1(ip13),vyw1(ip13),'ok');
% plot(Bx,By,'ok'); % fake position W1
